 ...
 */
public class TheStatusOfYourIdIsDeclined extends FetchingEmail {

    public TheStatusOfYourIdIsDeclined(String subjectKeyword) throws MessagingException {
    ...
    public String getStatus() {
        try {
            ...
            System.out.println("ID status, or letter doesnt recieved");
            return null;
        }
    }
